...
($out, $exit) = run('./t/data/input/dir ./t/data/output/out.zone --delete --managed ./t/data/output/managed.zone --grouping host', {
	'out.zone'     => q{test-a 999 IN A	255.255.255.255},
	'managed.zone' => q{test-b 600 IN	CNAME	example.com},
});
...
($out, $exit) = run('./t/data/input/dir ./t/data/output/out.zone --delete --managed ./t/data/output/managed.zone --grouping type', {
	'out.zone'     => q{test-a 999 IN A	255.255.255.255},
	'managed.zone' => q{test-b 600 IN	CNAME	example.com},
});
...
($out, $exit) = run('./t/data/input/dir ./t/data/output/out.zone --delete --managed ./t/data/output/managed.zone --grouping none', {
	'out.zone'     => q{test-a 999 IN A	255.255.255.255},
	'managed.zone' => q{test-b 600 IN	CNAME	example.com},
});
